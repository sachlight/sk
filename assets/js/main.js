...
//     setTimeout(function () {
//       ovrl.style.display = "-webkit-flex";
//     }, 400);
//   }
...
$(document).ready(function () {
  ...
  $(".lines-button").click(function () {
    ...
    $(".cases").toggle();
    $(".prot-details, .role-content").css({ "z-index": "1" });
  });
  $(".select-project li").click(function () {
...
$(function () {
  ...
  $(window).scroll(function () {
    if ($(this).scrollTop() > offset) {
      $(".work-page footer .about-us").css({ color: "#222" });
    } else {
      $(".work-page footer .about-us").css({ color: "#fff" });
    }
  });
});
...
$(window).scroll(function () {
  $(".lines-button span.lines").removeClass("change");
  $(".logo img").attr("src", "assets/images/logo-white.svg");
  $(".scroll-content").each(function () {
    var size = $(this).offset().top - 30;
    var height = size + $(this).innerHeight();
    var logo = $(this).data("logo-url");
    if ($(window).scrollTop() >= size && $(window).scrollTop() <= height) {
      $(".logo img").attr("src", logo);
      console.log(logo);
      if (logo == "assets/images/logo-white.svg") {
        $(".lines-button span.lines").removeClass("change");
      } else {
        $(".lines-button span.lines").addClass("change");
      }
    }
  });
});
